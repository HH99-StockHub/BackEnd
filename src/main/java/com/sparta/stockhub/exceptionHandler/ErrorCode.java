...
public enum ErrorCode {
    ...
    BAD_REQUEST_TITLELENGTH(HttpStatus.BAD_REQUEST, "400", "제목은 40자 이내로 작성해주세요."),
    BAD_REQUEST_POINTLENGTH(HttpStatus.BAD_REQUEST, "400", "투자포인트는 40자 이내로 작성해주세요."),
    BAD_REQUEST_CONTENTLENGTH(HttpStatus.BAD_REQUEST, "400", "세부 내용은 800자 이내로 작성해주세요."),
    BAD_REQUEST_COMMENTLENGTH(HttpStatus.BAD_REQUEST, "400", "댓글 내용은 300자 이내로 작성해주세요."),
    ...
    FORBIDDEN_OLDVOTEDOWN(HttpStatus.FORBIDDEN, "403", "이미 반대 푸툐를 하였습니다."),
